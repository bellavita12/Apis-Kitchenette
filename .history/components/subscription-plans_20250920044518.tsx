...
export function SubscriptionPlans() {
  ...
  const buttonHover = { scale: 1.05, transition: { duration: 0.3 } }
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid md:grid-cols-4 gap-8 max-w-7xl mx-auto">
          {plans.map((plan, index) => (
            ...
            >
              <Card className={`relative flex flex-col justify-between ${plan.popular ? "border-2 shadow-lg" : ""}`}>
                {plan.popular && (
                    ...
                    <Button
                      ...
                      className={`w-full text-white ${
                        plan.popular
                          ...
                          : "bg-[${themePrimary}] hover:bg-opacity-90"
                      }`}
                      size="lg"
