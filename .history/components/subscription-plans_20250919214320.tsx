...
const openWhatsApp = (planName: string) => {
  const message = encodeURIComponent(`Hello Apis Kitchenette, I am interested in the ${planName}. Can you share more details?`)
  const phone = "923001234567" // 👉 replace with your WhatsApp number, format: countrycode+number (without +)
