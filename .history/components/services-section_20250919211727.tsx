  ...
  const services = [
    {
      ...
      description:
        "Serving leading companies across Lahore, Karachi, and Islamabad with professional catering solutions that keep your workforce satisfied.",
    ...
    },
    {
      ...
      description:
        "Daily meal services for 2,000–3,000 employees, ensuring your workforce stays energized and productive.",
