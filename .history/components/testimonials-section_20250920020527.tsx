...
export function TestimonialsSection() {
  ...
  const testimonials = [
    ...
    {
      name: "Ali & Maria",
      event: "Anniversary Party - 80 Guests",
      rating: 5,
      text: "Apis Kitchenette helped us celebrate our golden anniversary in style! The food was restaurant-quality, the service was impeccable, and they handled every detail so we could focus on enjoying our special day with family and friends. Simply outstanding!",
    ...
    },
    {
      ...
      rating: 5,
      text: "Working with Apis Kitchenette for our charity fundraiser was a dream come true. They not only provided exceptional food and service but also helped us stay within budget while maximizing the impact of our event. True professionals who care about their clients' success.",
