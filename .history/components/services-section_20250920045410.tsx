      ...
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-16">
          ...
          <div className="flex flex-wrap justify-center gap-4 mt-8">
            <Badge className="text-lg px-4 py-2 bg-[#822527]/10 text-[#822527] border-[#822527]/20">✅ 5000+ People Capacity</Badge>
            <Badge className="text-lg px-4 py-2 bg-[#822527]/10 text-[#822527] border-[#822527]/20">✅ Corporate & Charitable Events</Badge>
            <Badge className="text-lg px-4 py-2 bg-[#822527]/10 text-[#822527] border-[#822527]/20">✅ Fresh, Hygienic & On-Time</Badge>
          </div>
        </div>
