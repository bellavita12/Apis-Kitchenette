...
Message: ${formData.message}
    ...
    const phoneNumber = "923226812281" // ✅ Your WhatsApp number
  ...
  return (
    <section id="contact" className="py-20 bg-background">
      <div className="container mx-auto px-4 max-w-4xl">
        ...
        <Card className="mb-16 animate-slide-in-up">
          <CardHeader>
            <CardTitle className="text-2xl font-[var(--font-space-grotesk)] text-center">
              Get Your Free Quote
            </CardTitle>
          </CardHeader>
          <CardContent>
        ...
        {/* Contact Info Cards - Only Call & Email */}
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 animate-slide-in-up">
          <Card>
            <CardContent className="p-8">
              ...
              <p className="text-2xl font-bold text-primary">+92 322 6812281</p>
          ...
          <Card>
            <CardContent className="p-8">
              ...
              <p className="text-lg font-semibold">apiskitchenette@gmail.com</p>
